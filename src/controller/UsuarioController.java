...
public class UsuarioController {
	...
	@PostMapping("/logar") // verif. dos dados informados pelo usu para login 
	public ResponseEntity<UsuarioLogin> logaUsuario(@Valid @RequestBody Optional<UsuarioLogin> user) { // optional entra na quest. das varuas possibilidades em login
